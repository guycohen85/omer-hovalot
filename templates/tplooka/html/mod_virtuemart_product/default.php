			...
			<div class="<?php echo $pwidth ?> <?php echo $float ?>">
				...
				<div class="spacer">
					...
					if ($show_price) {
						...
						/*echo '<span class="baseprice">'.'<span>מחיר </span>'.number_format($product->prices['product_price'],2).'<span> ₪</span>'.'</span>';*/

						if (!empty($product->prices['salesPrice'])) {
							if($product->prices['discountAmount'])
							{
								echo '<span class="baseprice">'.'<span>מחיר :</span>'.$currency->createPriceDiv ('product_override_price', '', $product->prices, FALSE, FALSE, 1.0, TRUE) .$currency->createPriceDiv ('discountAmount', '', $product->prices, FALSE, FALSE, 1.0, TRUE);
							}
							else
							{
							echo '<span class="baseprice">'.'<span>מחיר </span>'.$currency->createPriceDiv ('salesPrice', '', $product->prices, FALSE, FALSE, 1.0, TRUE);
							}
