...
echo '<div id="phocagallery" class="pg-category-view '.$this->category->title.' '.$this->params->get( 'pageclass_sfx' ). ' pg-cv">';
// Heading
...
if ($this->tmpl['show_page_heading'] != 0) {
	...
	if ( $heading != '') {
		...
		echo '<div class="page-header"><h2>'. $this->escape($heading) . '</h2></div>';
