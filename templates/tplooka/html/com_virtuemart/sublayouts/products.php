...
<div class="<?php echo $type ?>-view">
  ...
  <h4><?php echo $productTitle ?></h4>
	...
	<div class="product vm-col<?php echo ' vm-col-' . $products_per_row . $show_vertical_separator ?>">
		...
		<div class="spacer <?php if($product->prices['discountAmount']){ echo ' tags-sale-wrap ';}?>">
			<?php
			...
			<?php
				$equal_prices = (bool)($product->prices['basePriceWithTax'] == $product->prices['salesPrice']);
