...
<table width="100%" cellspacing="0" cellpadding="4" border="0" style="border:1px solid #BEBCB7;margin-bottom:10px;">
  ...
  <tr align="left" >
        <th colspan="3" class="vmsectiontableheader name"><?php echo $VM_LANG->_('PHPSHOP_CART_NAME') ?></th>
	...
	<th class="vmsectiontableheader delsumma" style="text-align: right;"><?php echo $VM_LANG->_('PHPSHOP_CART_SUBTOTAL') ?></th>
  </tr>
<?php 
$c = 0;
...
$product['row_color'] = 'sectiontableentry'.$i; 
 ?>
  <tr valign="top" class="<?php echo $product['row_color'] ?>">
	<td class="prod_name" colspan="3"><div class="image_checkout" <?php if (empty($product['product_full_image'])) echo 'style="display: none; " '; ?> ><?php 
	
	
	echo $this->op_show_image($product['product_full_image'], '', 100, 100, 'product'); ?></div><br /><?php echo $product['product_name'] . $product['product_attributes'] ?></td>
...
?>
  ...
  <tr <?php if (empty($discount_after) || (empty($coupon_display))) echo ' style="display:none;" '; ?>class="vmsectiontableentry1" id="tt_order_discount_after_div_basket">
    <td colspan="6" id="tt_order_discount_after_txt_basket" align="right"><?php echo $VM_LANG->_('PHPSHOP_COUPON_DISCOUNT') ?>:
    </td> 
  ...
  <tr class="total_td">
    ...
    <td class="vmsectiontableentry2 t1" colspan="1" align="right"><?php echo $VM_LANG->_('PHPSHOP_ORDER_PRINT_TOTAL') ?>: </td>
  ...
  <tr id="tt_tax_total_0_div_basket" style="display:none;" class="vmsectiontableentry1">
        ...
        <td class="b1" colspan="1" align="right" valign="top" id="tt_tax_total_0_txt_basket"><?php echo $VM_LANG->_('PHPSHOP_ORDER_PRINT_TOTAL_TAX') ?>: </td> 
