...
$cl = true; 
  ?>
<div class="continue_shopping2"><a href="<?php echo $continue_link ?>" class="continue_link2"><?php echo OPCLang::_('PHPSHOP_CONTINUE_SHOPPING') ?></a></div>
<?php 
} 
?>
</div>
...
<fieldset>
<legend class="sectiontableheader"><?php echo OPCLang::_('PHPSHOP_ORDER_PRINT_PAYMENT_LBL') ?>
</legend>
<?php echo $op_payment; ?>
</fieldset>
<?php 
...
<?php
	if(OPCLang::_('PHPSHOP_AGREEMENT_TOS')){
		$agreement_txt = OPCLang::_('PHPSHOP_AGREEMENT_TOS');
	}
...
<input type="submit" value="<?php echo OPCLang::_('PHPSHOP_ORDER_CONFIRM_MNU'); ?>" id="confirmbtn" class="buttonopc" <?php echo $op_onclick ?> />
</div>	
</div>
<br style="clear: both;"/>
</form>
