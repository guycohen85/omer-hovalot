...
<div id="guest_head" class="bandBoxStyle"><?php echo OPCLang::_('COM_ONEPAGE_REGISTER_AND_CHECKOUT'); ?></div>
 <div id="guest_container"><span><?php echo OPCLang::_('COM_ONEPAGE_GUEST_TEXT'); ?></span>
	...
	<div class="formField">
		<input type="email" id="guest_email" name="guest_email" class="inputbox" size="20" autocomplete="off" onblur="javascript: Onepage.email_check(this);" onkeyup="syncEmails(this);" <?php 
