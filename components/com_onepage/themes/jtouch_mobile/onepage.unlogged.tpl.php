...
<fieldset data-role="controlgroup" data-type="horizontal" >
			...
			<div data-role="fieldcontain">
				...
				<input type="text" id="username_login" name="username_login" value="" class="inputbox" size="20" autocomplete="off" />
...
<input data-role="button" data-transition="fade"  type="radio" id="sachone2_btn" name="sa" value="" checked="checked"    onclick="unhideFx2(this, 'sachone', 'checkout_section');" />
<label for="sachone2_btn"><?php echo OPCLang::_('COM_VIRTUEMART_ACC_BILL_DEF'); ?></label>
								
<input data-role="button" data-transition="fade" type="radio" id="sachone" name="sa" value="adresaina" onkeypress="" onclick="unhideFx2(this, 'sachone2_btn', 'checkout_section');"/>
<label for="sachone">
