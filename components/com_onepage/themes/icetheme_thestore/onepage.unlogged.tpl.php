...
?> 
 <?php if (empty($no_login_in_template)) { ?> 
		<li  class="op_list_li ?>" id="op_login_btn" onclick="javascript: return op_unhide('logintab', 'registertab','usertab');"  style="border: none;"><span class="op_round" id="op_round_and_separator" style="width: 150px;"><span style="width: 156px;"><?php echo OPCLang::_('COM_VIRTUEMART_LOGIN'); ?></span></span></li>  
		<li  class="op_list_li op_list_separator"><span ></span></li>
		<li  class="op_list_li" id="op_register_btn" onclick="javascript: return op_unhide('registertab', 'logintab','usertab');" style="border: none;"><span class="op_round" style="width: 150px;"><span id="span2" style="width: 160px; padding-left:0;"><?php echo OPCLang::_('COM_VIRTUEMART_REGISTER') ?></span></span></li>
 <?php } else { ?>
  <li  class="op_list_li " id="op_register_btn" onclick="javascript: return op_unhide('registertab', 'logintab','usertab');" style="border: none;"><span class="op_round" style="width: 150px;"><span style="width: 160px; padding-left:0;"><?php echo OPCLang::_('COM_VIRTUEMART_REGISTER') ?></span></span></li>
 <?php } ?>
 <?php if (!empty($has_guest_tab)) { ?>
  <li  class="op_list_li op_list_separator" ><span ></span></li>
  <li  class="op_list_li" id="op_guest_btn" onclick="javascript: return op_unhide('usertab','registertab', 'logintab');" style="border: none;"><span class="op_round" style="width: 150px;"><span id="span2" style="width: 160px; padding-left:0px;"><?php echo OPCLang::_('COM_ONEPAGE_REGISTER_AND_CHECKOUT') ?></span></span></li>
 <?php } ?>
  </ul>
</div>
                        	...
                        	<div class="op_rounded_content">
								...
								<div>
									<div id="usertab" style="display: none;">
										...
										<div class="formField">
											<input type="text" id="guest_email" name="guest_email" class="inputbox" size="20" autocomplete="off" />
										</div>
										<div class="formField" id="guestbtnfield" style="padding-left: 32%;" >
											<input type="button" name="GuestSubmit" class="button" value="<?php echo OPCLang::_('COM_ONEPAGE_SUBMIT'); ?>" onclick="return onGuestPressed(this); " />
										</div>
									</div>
								    <div id="registertab">
	...
	<br />
	<div class="formLabel">	<label for="remember_login"><?php echo $remember_me = VmConfig::isJ15()? OPCLang::_('Remember me') : OPCLang::_('JGLOBAL_REMEMBER_ME'); ?></label></div>
	<div class="formField">
...
{
//if(isset($cart->pricesUnformatted['billTotal']) && empty($cart->pricesUnformatted['billTotal'])) echo '<div style="display: none;">'; 
?>
...
<?php 
//if(isset($cart->pricesUnformatted['billTotal']) && empty($cart->pricesUnformatted['billTotal'])) echo '</div>'; 
} 
?>
<!-- end payment method -->
...
<!-- end show TOS and checkbox before button -->
 ...
 <div style="float: left; clear: both;">
	<button id="confirmbtn_button" type="submit" autocomplete="off" <?php echo $op_onclick ?>  ><span class="op_round"><span id="confirmbtn" style="width: 250px;"><?php echo OPCLang::_('COM_VIRTUEMART_ORDER_CONFIRM_MNU') ?></span></span></span></button>
 </div>
<br style="clear: both;"/>
</div>
