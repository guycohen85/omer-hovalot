...
*/		
		...
		*/
		...
		if (in_array('register_account', $business_fields))
			echo ' id="opc_business_register_account" style="display: none;"';
		echo '>'; 
				echo '<div class="formLabel" id="register_label">
						...
						echo '" onclick="javascript: return showSAreg(this);" autocomplete="off" ><div style="float: left;">&nbsp;</div><div id="register_span" class="register_span">'.OPCLang::_('COM_VIRTUEMART_ORDER_REGISTER').'</div></button>
					</div>
				<div class="formField">
