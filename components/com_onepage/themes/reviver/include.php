...
JHTML::script('placeholder.js', 'components/com_onepage/themes/'.$selected_template, false);
JHTML::script('jquery.formstyler.min.js', 'components/com_onepage/themes/'.$selected_template, false);
