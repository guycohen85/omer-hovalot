...
*/
 ...
 $opc_cr_type = 'save_all';  $bt_fields_from = '0';  $op_default_shipping_search = array(); $use_original_basket = false; 
    $theme_fix1 = false; 
    ...
    $do_not_allow_gift_deletion = false; 
     $gift_order_statuses = array(); $opc_async = false; 
    $use_free_text = false; 
...
$email_after = false;
 ...
 $opc_usmode = false;  $full_tos_logged = false;  $tos_scrollable = false;  $full_tos_unlogged = true;  $tos_logged = true;  $tos_unlogged = true;  $opc_email_in_bt = false;  $double_email = false;  $coupon_price_display = "salesPriceCoupon";
